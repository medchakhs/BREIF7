    ...
    <section class="form-container open" id="mmm">
        <form action="" method="POST">
            <div class="form-group">
                ...
                <label class="labl"> Name Nationality</label>
    ...
    <section class="section">
      ...
      <?php 
            ...
            while($row = mysqli_fetch_assoc($result)){
              ...
              echo '<td> <a href="deletnatio.php?id='.$row['Id_nationality'].'"> <button>Supprimer</button> </a> </td>';
              echo '<td> <a href="ubdatenatio.php?id='.$row['Id_nationality'].'"> <button>Modifier</button> </a> </td>';
              echo '</tr>';
            } 
        ?>
        </tbody>
